...
import styles from './createTrailer.module.css';
import ProgressBar from '@/components/ui/progressBar/progressBar';

export default function CreateTrailer({ courseId }) {
  ...
  const onAddAdminSubmitHandler = (event) => {
    ...
    axiosFetch({
    	method: 'POST',
    	url: configuration.courses + '/' + courseId + '/trailer',
  ...
  return (
    <div className={styles.main}>
      <form className={styles.form} onSubmit={onAddAdminSubmitHandler} ref={formRef}>
        <p className={styles.subTitle}>Trailer details:</p>
        <p className={styles.label}>Course Trailer</p>
        <Input type="file" placeholder="Upload course trailer" name="video" variant="secondary" required />
