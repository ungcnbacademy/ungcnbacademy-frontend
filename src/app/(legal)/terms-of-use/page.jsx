      ...
      <div className={styles.container}>
        ...
        <ul>
          <li>
            ...
            We may update these Terms from time to time. If a material change is
            made, we will post a notice on the Platform or send you a
            notification. Read through any changes, and if you don&apos;t agree
            to them, please stop using the Platform. If you continue to use our
            Platform after we notify you of changes, you will be deemed to have
            accepted the updated Terms, except to the extent prohibited by
            applicable law.
          </li>
          <li>
            <b>Terms of Sale.</b> By making any purchase with us, you also agree
            to the Terms of Sale that apply.
          </li>
          <li>
            <b>Privacy Policy.</b> Our Privacy Policy describes the collection
            and use of personal information on the Platform and applies to your
            use of the Platform.
          </li>
          <li>
            <b>Important Notice for Amateur Athletes.</b> You are responsible
            for ensuring that your participation on the Platform does not affect
        ...
        <br />
        <p>
          <b>Eligibility.</b> You are only eligible to use the Platform if you
          are of legal age in your country or if you have consent from your
          parent or guardian. There may be certain age restrictions for specific
          Platform services in various countries.
        </p>
        <br />
        <p>
          <b>Rules for Registration.</b> When you register for an account with
          us, the following rules apply:
        </p>
        <br />
        <ul>
          <li>
            <b>Be True:</b> Provide accurate and current registration
            information.
          </li>
          <li>
          ...
          <li>
            <b>Be Secure:</b> Keep your username, password and other login
        ...
        <br />
        <p>
          Except for User Content (defined below), all of the content on our
        ...
        <ul>
          ...
          <li>
            You agree not to change or delete any ownership notices from
        ...
        <ul>
          <li>
            ...
            Content, or any of the concepts or ideas contained in the User
        ...
        <ul>
          <li>
            <b>Be Original.</b> Only post User Content to the Platform if you
            have all permissions and rights needed to make that User Content
            available, including from any individuals who appear or are
          ...
          <li>
            Do not post User Content that contains software viruses, programmes
            or other computer code, and do not circumvent or modify any Platform
            software or security technology.
          </li>
          <li>
            Do not use any data mining, robots, scraping or similar data
            gathering methods.
          </li>
          <li>
            Unless we indicate otherwise, our Platform is a public place. Do not
            post personal information to the Platform – yours or anybody
            else&apos;s.
          </li>
          <li>
            <b>Be Personal.</b>
          ...
          <li>
            Do not post any advertising, solicitation or commercial content on
            the Platform or accept payment from a third party in exchange for
          ...
          <li>
            <b>Be Appropriate.</b> Respect the community and do not post User
        ...
        <br />
        <p>
          If you believe that your work has been improperly copied to the
          Platform, such that it constitutes infringement, please provide us
          with the following information
        </p>
        <br />
        <p>
          (1) name, address, telephone number, email address and an electronic
          or physical signature of the copyright owner or of the person
        ...
        <br />
        <p>
          (3) a description of where on the Platform the content that you claim
          is infringing is located;
        </p>
        <br />
        <p>
          (4) a written statement that you have a good faith belief that the
          disputed use is not authorised by the copyright owner, its agent, or
          the law; and
        </p>
        <br />
        <p>
          (5) a statement by you, made under penalty of perjury (depending on
          applicable law), that the above information in your notice is accurate
          and that you are the copyright owner or authorised to act on the
        ...
        <br />
        <p>
          <b>PHYSICAL ACTIVITY.</b> The Platform may include features that
          promote physical activity, nutrition or general wellness. They are for
          your informational purposes only and are not intended as medical
          advice or services, or for diagnostic or treatment purposes.
        </p>
        <br />
        <ul>
          <li>
            Consider the risks involved and consult with your medical
            professional before engaging in any physical activity.
          </li>
          <li>
        ...
        <br />
        <p>
          <b>USER INTERACTIONS.</b> To the extent allowed by applicable law, we
          are not responsible for your interactions with other users of the
          Platform or any damage or harm you may experience because of these
          interactions.
        </p>
        <br />
        <ul>
          <li>
            Be responsible and take precautions when interacting with other
        ...
        <p>
          <b>
            WARRANTY DISCLAIMER. Some jurisdictions do not permit certain
            limitations or exclusions on liabilities, legal warranties and
            remedies, so these exclusions and limitations may not apply to you.
          </b>
        </p>
        <br />
        <ul>
          <li>
            The Platform, Content, and the materials and products on this
          ...
          <li>
            You are solely responsible for any damage to your Device resulting
            from accessing the Platform, to the extent applicable law does not
            provide otherwise.
          </li>
          <li>
            We hope you enjoy and get the full benefit of the Platform; however,
        ...
        <ul>
          <li>
            You understand and agree that some of your User Content,
            particularly that which is displayed in an activity feed or in other
            public places on the Platform, may continue to appear publicly even
            after your account is terminated, subject to your right to have your
            User Content removed upon request in accordance with applicable law.
          </li>
          <li>
            These Terms remain in effect even after your account is terminated
            or you have stopped using the Platform.
          </li>
        </ul>
        <br />
        ...
        <p>
          ...
          conduct in connection with the Platform or with other Platform users,
        ...
        <p>
          <b>
            LIMITATION OF LIABILITY. Some jurisdictions do not permit certain
            limitations or exclusions on liabilities, legal warranties and
            remedies, so these exclusions/limitations may not apply to you.
          </b>
        </p>
        <br />
        ...
        <ul>
          ...
          <li>
            Except where prohibited by applicable law, and without limitation to
          ...
          <li>
            You consent to waive all defences of &apos;lack of personal
            jurisdiction&apos; and &apos;inconvenient forum&apos; with respect
            to venue and jurisdiction.
          </li>
          <li>
            All claims shall be brought within one (1) year after the claim
            arises, except to the extent a longer period is required by
            applicable law.
          </li>
        </ul>
        <br />
        ...
        <ul>
          ...
          <li>
            ...
            the remainder of these Terms shall continue to be enforceable.
          </li>
        </ul>
        <br />
